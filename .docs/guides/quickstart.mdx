---
title: "Quick Start"
description: "Guia rapida para inicializar cada microservicio en desarrollo."
icon: "rocket"
---
...
1. **Crear primer endpoint**: [Ver Lineamientos de Desarrollo](/project/dev-guidelines)
2. **Agregar página en Frontend**: [Ver Lineamientos de Desarrollo](/project/dev-guidelines)
3. **Entrenar modelo de IA**: [Ver guía de Entrenamiento CNN](/ai/cnn-training)
4. **Configurar CI/CD**: [Ver Checklist Pre-PR](/guides/pr-checklist)
