---
title: "Guia de Desarrollo Local"
description: "Configuracion y flujo de trabajo para desarrollo local del monorepo."
icon: "laptop-code"
---
...
bash run.sh mobile        # Solo Frontend Mobile (Expo)
bash run.sh docs          # Solo documentacion (Mintlify)
bash run.sh core ai web   # Backend + AI + Frontend Web
bash run.sh web docs      # Frontend Web + Documentacion
bash run.sh all           # Docker + core + ai + web
```
...
- ✅ Documentacion en `http://localhost:3333` (si se lanzo `docs`)
...
```bash
# 1. Abre las terminales necesarias (o usa run.sh para automatizar)
...
# Terminal 6: Documentacion (OPCIONAL)
$ cd .docs
$ npm run docs
...
# - Documentacion:         http://localhost:3333
...
- [Lineamientos de Desarrollo](/project/dev-guidelines)
- [AI Service Setup](https://github.com/Zack4U/bioplatform/blob/main/src/Bio.Backend.AI/README.md)
- [Frontend Web](https://github.com/Zack4U/bioplatform/blob/main/src/Bio.Frontend.Web/README.md)
- [Mobile App](https://github.com/Zack4U/bioplatform/blob/main/src/Bio.Frontend.Mobile/README.md)
