...
description: "Plan de desarrollo detallado y checklist de tareas."
icon: "list-check"
---
...
* **[X] CRUD de Especies y Taxonomía (API):**  
  * **Descripción:** Endpoints REST genéricos para catalogación. Incluye validación del flag is_sensitive en el GetSpeciesQuery para enmascarar coordenadas en el DTO de respuesta si aplica.  
  * **Tecnologías obligatorias:** MediatR, Dapper (lecturas rápidas), EF Core (escrituras).  
* **[X] Job de Carga Masiva CSV:**  
...
* **[X] Recolección y Limpieza de Dataset (Flora/Fauna):**  
...
* **[X] Microservicio FastAPI de Inferencia:**  
  * **Descripción:** Creación del endpoint POST /api/ai/classify. Debe recibir una imagen en multipart/form-data, pre-procesarla, ejecutar el modelo y devolver el Top-3 de predicciones con el class_id y % confidence.  
  * **Tecnologías obligatorias:** Python 3.11, FastAPI, Uvicorn, Pydantic.  
* **[X] Integración Gateway e IAC:**  
...
* **[X] CRUD de Permisos ABS (Decisión 391):**  
...
* **[X] CRUD de Productos de Biocomercio:**  
  * **Descripción:** Endpoints para gestión de productos. **Regla estricta:** El CreateProductCommandHandler debe consultar en base de datos si el usuario tiene un Permiso ABS activo para la base_species_id; si no, retorna error 403 Forbidden.  
...
* **[X] Consultas de Trazabilidad y Dashboard:**  
...
* **[X] Pruebas Unitarias y Mocking (>70%):**  
...
* **[X] Ajustes Finales y Documentación Swagger:**  
...
* **[X] Capa de Servicios API Web/Móvil:**  
...
* **[X] Pantallas Login/Registro Web:**  
...
* **[X] Ficha Técnica de Especie (Web/Móvil):**  
...
* **[X] Integración de Mapas GIS (Web):**  
...
* **[X] Interfaz de Cámara Inteligente (Móvil):**  
...
* **[X] Captura y Manejo de Imagen (Móvil):**  
...
* **[X] Conexión Móvil con CNN (Móvil):**  
...
* **[X] Visualizador de Resultados (Móvil):**  
...
* **[X] UI Marketplace y Tarjetas de Producto (Web):**  
...
* **[X] Formulario de Permisos ABS (Web):**  
...
* **[X] Dashboard de Emprendedor (Web):**  
...
* **[X] Configuración Base de Datos Local (Móvil):**  
