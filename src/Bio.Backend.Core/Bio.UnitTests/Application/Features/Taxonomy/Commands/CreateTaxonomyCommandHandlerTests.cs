...
public class CreateTaxonomyCommandHandlerTests
{
    ...
    public CreateTaxonomyCommandHandlerTests()
    {
        ...
        _repositoryMock.Setup(r => r.AddAsync(It.IsAny<Taxonomy>(), It.IsAny<CancellationToken>()))
    ...
    public async Task Handle_Should_ReturnTaxonomyResponseDTO()
    {
        ...
        _repositoryMock.Verify(r => r.AddAsync(It.IsAny<Taxonomy>(), It.IsAny<CancellationToken>()), Times.Once);
