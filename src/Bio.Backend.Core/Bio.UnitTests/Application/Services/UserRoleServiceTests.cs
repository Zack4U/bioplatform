...
public class UserRoleServiceTests
{
    ...
    /// <summary>
    /// Tests for the AssignRoleAsync method.
    /// </summary>
    public class AssignRole : UserRoleServiceTests
    {
        /// <summary>
        /// Verifies that a valid role assignment is successfully processed and saved.
        /// </summary>
        [Fact]
        public async Task ValidData_ShouldAssignRole()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public async Task UserNotFound_ShouldThrowKeyNotFoundException()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public async Task DuplicateAssignment_ShouldThrowInvalidOperationException()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var roleId = Guid.NewGuid();
    ...
    /// <summary>
    /// Tests for the UnassignRoleAsync method.
    /// </summary>
    public class UnassignRole : UserRoleServiceTests
    {
        /// <summary>
        /// Verifies that an existing role assignment is successfully removed.
        /// </summary>
        [Fact]
        public async Task ExistingAssignment_ShouldRemoveRole()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var roleId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task NonExistingAssignment_ShouldThrowKeyNotFoundException()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var roleId = Guid.NewGuid();
    ...
    /// <summary>
    /// Tests for the GetAllAssignmentsAsync method.
    /// </summary>
    public class GetAllAssignments : UserRoleServiceTests
    {
        /// <summary>
        /// Verifies that all user-role assignments are retrieved with their details.
        /// </summary>
        [Fact]
        public async Task ShouldReturnAssignments()
        {
            // Arrange
    ...
    /// <summary>
    /// Tests for the GetAssignmentsByUserIdAsync method.
    /// </summary>
    public class GetAssignmentsByUserId : UserRoleServiceTests
    {
        /// <summary>
    ...
    /// <summary>
    /// Tests for the GetAssignmentsByRoleNameAsync method.
    /// </summary>
    public class GetAssignmentsByRoleName : UserRoleServiceTests
    {
        /// <summary>
    ...
    /// <summary>
    /// Tests for the GetAssignmentsByRoleIdAsync method.
    /// </summary>
    public class GetAssignmentsByRoleId : UserRoleServiceTests
    {
        /// <summary>
