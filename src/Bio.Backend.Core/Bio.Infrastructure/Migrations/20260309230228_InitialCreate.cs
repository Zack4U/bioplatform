        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolutionNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EmissionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpirationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GrantingAuthority = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbsPermits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AbsPermits_Users_EntrepreneurId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntrepreneurId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BaseSpeciesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Users_EntrepreneurId",
                        column: x => x.EntrepreneurId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificationBody = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certifications_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsPermits_EntrepreneurId",
                table: "AbsPermits",
                column: "EntrepreneurId");

            migrationBuilder.CreateIndex(
                name: "IX_AbsPermits_ResolutionNumber",
                table: "AbsPermits",
                column: "ResolutionNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AbsPermits_SpeciesId",
                table: "AbsPermits",
                column: "SpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_Certifications_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_BaseSpeciesId",
                table: "Products",
                column: "BaseSpeciesId");
