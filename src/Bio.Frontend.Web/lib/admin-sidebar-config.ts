        ...
        items: [
            {
                ...
                iconName: "MessageSquare",
                roles: ["ADMIN", "AUTHORITY", "COMMUNITY"],
            },
            {
...
export const ROUTE_REQUIRED_ROLES: Record<string, import("@/types").UserRoleName[]> = {
    ...
    "/admin/community-posts": ["ADMIN", "AUTHORITY", "COMMUNITY"],
    "/admin/community-comments": ["ADMIN", "AUTHORITY", "COMMUNITY"],
