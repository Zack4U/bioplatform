...
import type { ManageProductListItem, ProductCategory, AbsPermit, ProductDetailDTO } from "@/types";
...
export function ProductsManagement() {
    ...
    const [managingImagesProduct, setManagingImagesProduct] = useState<ManageProductListItem | null>(null);

    // Fetch full details of the product being image-managed to get its images
    const { data: productDetail, isLoading: isLoadingImages } = useQuery<ProductDetailDTO | null>({
        ...
        <div className="space-y-6">
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Administra tus productos, precios e inventario</p>
                </div>
            ...
            {managingImagesProduct && (
                <ProductImageManager
                    ...
                    onUpload={(file, isPrimary, altText) => {
                        uploadImage(managingImagesProduct.id, file, isPrimary, altText);
                    }}
