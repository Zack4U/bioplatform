/**
 * ProductGrid — responsive grid/list layout for product cards.
 *
 * UI ONLY — renders product items in the selected view mode.
 * Delegates to ProductCard for individual rendering.
 * Shows loading skeletons, empty state, or error fallback.
 *
 * Toolbar: [Filter toggle (left)] ... [Sort dropdown | View mode toggle (right)]
 * Mirrors SpeciesGrid toolbar exactly.
 *
