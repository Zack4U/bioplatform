 ...
 *
 * Logic delegated to:
 *  - useProductCatalog  → search, filters, pagination, sorting
 *  - useFavorites       → favorites set + toggle mutation
 *
...
import { useFavorites, useProductCatalog } from "@/hooks/features/marketplace";
  ...
  return (
    <main className="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      <PageHeader
        ...
        breadcrumbs={[{ label: "Inicio", href: "/" }, { label: "Marketplace" }]}
      />
      ...
      <div className="flex gap-6">
        ...
        <div
          className={cn(
            ...
            isFiltersPanelOpen ? "w-64 opacity-100" : "w-0 opacity-0",
          )}
        >
        ...
        <div className="flex-1 min-w-0">
          <ProductGrid
            ...
            onToggleFiltersPanel={() => setIsFiltersPanelOpen((prev) => !prev)}
            favorites={favorites.favoriteIdSet}
